...
/*
	...
	/*@RequestMapping(value = "/test/login2.do", method = { ReqestMethod.GET, ReqestMethod.POST})
	public ModelAndView login2(@RequestParam("userID") String userID
	...
	/*@RequestMapping(value = "/test/login3.do", method = { ReqestMethod.GET, ReqestMethod.POST})
	...
	/*@RequestMapping(value = "/test/login4.do", method = { ReqestMethod.GET, ReqestMethod.POST})
